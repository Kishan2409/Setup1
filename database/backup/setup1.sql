...
(5, '2023_10_31_042221_create_settings_table', 1),
(6, '2023_11_04_041502_create_sliders_table', 1);
...
(1, 'SETUP1', '41638.jpg', '95127.png', '2023-12-21 02:43:48', '2023-12-21 02:43:48');
...
CREATE TABLE IF NOT EXISTS `sliders` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sliders_added_by_foreign` (`added_by`),
...
(1, 'admin', 'admin@test.com', NULL, '$2y$10$bIb2KI2wZUdJDMomtePBWeNcWEgMmR/UH7sUYVq7bSC.B8F65eda.', NULL, '2023-12-21 02:43:00', '2023-12-21 02:43:28');
