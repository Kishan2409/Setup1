                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control"
                                            placeholder="Enter title" value="{{ $data->title }}" disabled>
                                    </div>
                                    <div class="col-md-12 mb-2">
                                        <label for="description">Description </label>
                                        <textarea name="description" id="description" class="form-control" placeholder="Enter description" disabled>{{ $data->description }}</textarea>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $("#update").validate({
                ...
                messages: {
                    image: {
                        extension: "Select valid file with extension like .Jpeg,.png,.jpg for logofile field."
                    },
                    description: {
